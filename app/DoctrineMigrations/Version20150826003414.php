...
class Version20150826003414 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE work_orders (id INT AUTO_INCREMENT NOT NULL, customer_id INT DEFAULT NULL, location_id INT DEFAULT NULL, project_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, status VARCHAR(100) NOT NULL, schedule_date DATE NOT NULL, created_date DATETIME NOT NULL, close_date DATETIME DEFAULT NULL, work_order_type_id INT NOT NULL, short_description VARCHAR(255) NOT NULL, long_description LONGTEXT NOT NULL, po_number VARCHAR(100) DEFAULT NULL, INDEX IDX_4ED63BCC9395C3F3 (customer_id), INDEX IDX_4ED63BCC64D218E (location_id), INDEX IDX_4ED63BCC166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
